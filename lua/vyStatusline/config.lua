...
function M.setup(user_config)
	...
	local hl = {
		...
		vyFileIcon = { bg = colors.none, fg = colors.sage, default = true },
		vyFile = { bg = colors.none, fg = colors.sage, default = true },
		...
		vyLspProgress = { bg = colors.none, fg = colors.cyan, default = true },
		vySpacer = { link = "StatusLine", default = true },
		vySep = { link = "StatusLine", default = true },
		-- Mode highlights (linked to universal groups)
		vyNormalMode = { bg = colors.none, fg = colors.sage, default = true },
		vyInsertMode = { bg = colors.none, fg = colors.purple, default = true },
		vyVisualMode = { bg = colors.none, fg = colors.steel, default = true },
		vyCommandMode = { bg = colors.none, fg = colors.peach, default = true },
		vySelectMode = { bg = colors.none, fg = colors.steel, default = true },
		vyReplaceMode = { bg = colors.none, fg = colors.peach, default = true },
		vyTerminalMode = { bg = colors.none, fg = colors.cyan, default = true },
		vyConfirmMode = { bg = colors.none, fg = colors.cyan, default = true },
		vyNTerminalMode = { bg = colors.none, fg = colors.sage, default = true },
		-- Special mode highlights
		vyExplorerMode = { bg = colors.none, fg = colors.rose, default = true },
		vyLazyGitMode = { bg = colors.none, fg = colors.purple, default = true },
		vyLazyNvimMode = { bg = colors.none, fg = colors.steel, default = true },
	}
